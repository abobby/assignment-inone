        ...
        <div class="col-md-12">
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    ...
                    @endif
                    <form id="memberadd" class="form" method="post" action="{{url('member/update-member')}}">
                        {{csrf_field()}}
                        <input type="hidden" name="memid" value="{{$userinfo->id}}" />
                        <div class="row">
                            <div class="col-md-6 text-left">
                                ...
                                <div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                                    ...
                                    <input type="text" name="phone" placeholder="Mobile Number" value="{{$userinfo->phone}}" class="form-control" />
                                    @if ($errors->has('phone'))
                                    <span class="help-block">
                                ...
                                <div class="form-group{{ $errors->has('country') ? ' has-error' : '' }}">
                                    ...
                                    <select name="country" class="form-control" required>
                                        ...
                                        @foreach($countries AS $country)
                                            <option value="{{$country->code}}" @if($userdetail->country == $country->code) selected @endif>{{$country->name}}</option> 
                                        @endforeach
                                    </select>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <button type="submit" class="btn btn-lg btn-success">Update Member</button>
                            </div>
                        </div>
                    </form>
                </div>
